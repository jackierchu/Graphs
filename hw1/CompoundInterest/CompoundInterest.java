...
public class CompoundInterest {
    ...
    static double futureValueReal(double presentValue, double rate,
        ...
        return futureValue(
                futureValue(presentValue, rate, targetYear), //Get projected value
    ...
    static double totalSavingsReal(double perYear, int targetYear, double rate,
        ...
        return futureValue(
                totalSavings(perYear, targetYear, rate),
                -inflationRate, targetYear); //Then compensate for the inflation rate.
    ...
    static void printSavingsFV(int targetYear, double returnRate,
        ...
        double nominalSavings = CompoundInterest.totalSavings(perYear,
                targetYear, returnRate); // replace 0 with your code
        double realSavings = CompoundInterest.totalSavingsReal(perYear,
                targetYear, returnRate, inflationRate);    // replace 0 with your code
        // Do not change anything in this method below this line
